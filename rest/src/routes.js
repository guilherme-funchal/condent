...
// router.get('/situacoes_agenda'Situacoes_AgendaController
...
// router.put('/tratamento/:id',TratamentoController.update)
// router.get('/tratamento',TratamentoController.list)
